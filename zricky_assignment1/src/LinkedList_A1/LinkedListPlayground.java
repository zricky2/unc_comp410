...
public class LinkedListPlayground {
	...
	public static void test1() {
		...
		System.out.println(L.isEmpty());
		printList(L);
		System.out.println(L.getRoot().toString());
		L.insert(3.3, 0);
		System.out.println(L.isEmpty());
		printList(L);
		System.out.println(L.getRoot().next.toString());
		L.insert(3.4, 0);
		L.insert(3.5, 0);
		L.insert(3.67, 1);
		L.insert(3.357, 0);
	...
	public static void test3() {
		...
		LinkedListImpl L = new LinkedListImpl();
		System.out.println(L.get(0));//NaN
		L.insert(1,1);
		L.insert(0,0);
		L.insert(1,1);
		L.insert(2,2);
		...
		L.insert(4,4);
		L.remove(5);
		System.out.println(L.remove(6)); // false
		L.remove(1);
	...
	public static void printList(LinkedListImpl L) {
		...
		Node curr = L.getRoot().next; // the first data node in the list is the one after sentinel.
